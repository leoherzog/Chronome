...
// Loaded by service/eventProperties.js only (service process)
// Adapted from MeetingBar by Andrii Leitsius (https://github.com/leits/MeetingBar), Apache-2.0
...
const MEETING_URL_PATTERNS = [
    ...
    // Discord
    /(?:https?|discord):\/\/(?:www\.)?(?:canary\.)?discord(?:app)?\.(?:gg|com)\/(?:invite|channels|events)?\/?[A-Za-z0-9\-_\/]+/i,
